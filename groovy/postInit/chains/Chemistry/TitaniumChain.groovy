...
BR.recipeBuilder()
//.fluidInputs(fluid('acidic_wastewater') * 1000)       // TODO: Add material
...
.inputs(ore('dustIlmenite'))
.inputs(ore('dustCoke'))
.fluidOutputs(fluid('gaseous_iron_iii_chloride') * 950)
...
.chancedOutput(ore('dustMagnesiumChloride').first() * 6, 9000, 0)
.duration(300)
...
.chancedOutput(fluid('magnesium_chloride') * 144, 6000, 0)
...
.fluidOutputs(fluid('h++ydrochloric_acid') * 6000)
.duration(160)
.EUt(Globals.voltAmps[1])
.buildAndRegister()
